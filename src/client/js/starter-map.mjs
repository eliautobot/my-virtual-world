  ...
  },
  {
    ...
    interior: {
      ...
      furniture: [
        ...
        {
          type: 'counter',
          x: 24.187948209976394,
          z: 0.7904121338362842,
          rotation: 0,
          floor: 1,
          buildingFloor: 1,
          stationary: true,
          ...
          lifecycle: {
            ...
            surfaceMount: {
              ...
              accepts: ['countertopCoffeeMachine', 'microwave'],
              interaction: 'counter stores placement slots only; agents target the placed appliance, not the counter',
            },
          },
          applianceSlots: [
            { id: 'appliance-left', dx: -0.86, dz: 0, y: 0.91, accepts: ['countertopCoffeeMachine', 'microwave'], occupiedBy: null },
            { id: 'appliance-center', dx: 0, dz: 0, y: 0.91, accepts: ['countertopCoffeeMachine', 'microwave'], occupiedBy: 19 },
            { id: 'appliance-right', dx: 0.86, dz: 0, y: 0.91, accepts: ['countertopCoffeeMachine', 'microwave'], occupiedBy: 18 },
          ],
          counterState: {
            applianceSlotCount: 3,
            occupiedApplianceSlots: 2,
            acceptsAppliances: ['countertopCoffeeMachine', 'microwave'],

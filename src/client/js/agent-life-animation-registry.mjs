...
const DEFAULT_ANIMATION_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    label: 'Counter Prep',
    priority: 78,
    triggerKinds: Object.freeze(['runtime-flag', 'world-action', 'asset-id']),
    triggers: Object.freeze({ runtimeFlags: Object.freeze(['agent._idleActivity.kind=counter-*']), assets: Object.freeze(['counter']), actionPatterns: Object.freeze(['prepAtCounter', 'counter prep']) }),
    pose: Object.freeze({ stance: 'standing', locomotion: 'stationary', blendMode: 'replace', bodyLean: 0.18, armMode: 'chop-mix-prep' }),
    runtimeAdapters: Object.freeze({ currentBranches: Object.freeze(['agent-characters.js core counter prep branch']), currentFlags: Object.freeze(['agent._idleActivity.kind=counter-*']) }),
  }),
  Object.freeze({
    id: 'stove-cook',
    label: 'Stove Cook',
    priority: 79,
    triggerKinds: Object.freeze(['runtime-flag', 'world-action', 'asset-id']),
    triggers: Object.freeze({ runtimeFlags: Object.freeze(['agent._idleActivity.kind=stove-*']), assets: Object.freeze(['stove']), actionPatterns: Object.freeze(['cookAtStove', 'stove cook']) }),
    pose: Object.freeze({ stance: 'standing', locomotion: 'stationary', blendMode: 'replace', bodyLean: 0.20, armMode: 'stir-flip-cook' }),
    runtimeAdapters: Object.freeze({ currentBranches: Object.freeze(['agent-characters.js core stove cook branch']), currentFlags: Object.freeze(['agent._idleActivity.kind=stove-*']) }),
  }),
  Object.freeze({
    id: 'stovetop-cook',
    label: 'Stovetop Stir / Sizzle / Toss',
    priority: 90,
    triggerKinds: Object.freeze(['runtime-flag', 'world-action', 'asset-id', 'action-location-role']),
    triggers: Object.freeze({ runtimeFlags: Object.freeze(['agent._idleActivity.kind=stovetop-*']), roles: Object.freeze(['use', 'cook', 'stovetop']), assets: Object.freeze(['stove']), actionPatterns: Object.freeze(['cookOnStovetop', 'stovetop']) }),
    pose: Object.freeze({ stance: 'standing', locomotion: 'stationary', blendMode: 'replace', bodyLean: 0.20, armMode: 'stir-pan-toss' }),
    runtimeAdapters: Object.freeze({ currentBranches: Object.freeze(['agent-characters.js stovetop stir/toss branch']), currentFlags: Object.freeze(['agent._idleActivity.kind=stovetop-*']) }),
  }),
  Object.freeze({
    id: 'oven-use',
    label: 'Oven Open / Load / Heat / Retrieve',
    priority: 90,
    triggerKinds: Object.freeze(['runtime-flag', 'world-action', 'asset-id', 'action-location-role']),
    triggers: Object.freeze({ runtimeFlags: Object.freeze(['agent._idleActivity.kind=oven-*']), roles: Object.freeze(['use', 'cook', 'bake', 'oven']), assets: Object.freeze(['stove']), actionPatterns: Object.freeze(['bakeInOven', 'oven']) }),
    pose: Object.freeze({ stance: 'standing-crouch', locomotion: 'stationary', blendMode: 'replace', bodyLean: 0.32, armMode: 'open-load-close-wait-retrieve' }),
    runtimeAdapters: Object.freeze({ currentBranches: Object.freeze(['agent-characters.js oven load/heat/retrieve branch']), currentFlags: Object.freeze(['agent._idleActivity.kind=oven-*']) }),
  }),
  Object.freeze({
    id: 'stove-oven-desk-consume',
    label: 'Consume Cooked Food at Desk',
    priority: 91,
    triggerKinds: Object.freeze(['runtime-flag', 'world-action']),
    triggers: Object.freeze({ runtimeFlags: Object.freeze(['agent._idleActivity.kind=stove-oven-desk-consume']), roles: Object.freeze(['eat']), assets: Object.freeze(['desk']), actionPatterns: Object.freeze(['eatStoveOvenFoodAtDesk']) }),
    pose: Object.freeze({ stance: 'seated', locomotion: 'stationary', blendMode: 'replace', bodyLean: 0.12, armMode: 'tabletop-eat-three-bites' }),
    runtimeAdapters: Object.freeze({ currentBranches: Object.freeze(['agent-characters.js shared desk consumption branch']), currentFlags: Object.freeze(['agent._idleActivity.kind=stove-oven-desk-*']) }),
  }),
  Object.freeze({
    id: 'sink-wash-drink',
    label: 'Sink Wash / Drink',
    priority: 78,
    triggerKinds: Object.freeze(['runtime-flag', 'world-action', 'asset-id']),
    triggers: Object.freeze({ runtimeFlags: Object.freeze(['agent._idleActivity.kind=sink-*']), assets: Object.freeze(['sink']), actionPatterns: Object.freeze(['useSink', 'wash at sink', 'drink at sink']) }),
    pose: Object.freeze({ stance: 'standing', locomotion: 'stationary', blendMode: 'replace', bodyLean: 0.22, armMode: 'two-hand-wash-rinse' }),
    runtimeAdapters: Object.freeze({ currentBranches: Object.freeze(['agent-characters.js core sink wash/drink branch']), currentFlags: Object.freeze(['agent._idleActivity.kind=sink-*']) }),
  }),
  Object.freeze({
    id: 'dining-table-eat-talk',
    label: 'Dining Table Eat / Talk',
    priority: 79,
    triggerKinds: Object.freeze(['runtime-flag', 'world-action', 'asset-id']),
    triggers: Object.freeze({ runtimeFlags: Object.freeze(['agent._idleActivity.kind=dining-table-*']), assets: Object.freeze(['diningTable']), actionPatterns: Object.freeze(['eatAtDiningTable', 'talkAtDiningTable']) }),
    pose: Object.freeze({ stance: 'seated', locomotion: 'stationary', blendMode: 'replace', bodyLean: 0.16, armMode: 'eat-sip-talk' }),
    runtimeAdapters: Object.freeze({ currentBranches: Object.freeze(['agent-characters.js dining table seated eat/talk branch']), currentFlags: Object.freeze(['agent._idleActivity.kind=dining-table-*']) }),
  }),
  Object.freeze({
    id: 'meeting-sit-talk',
    label: 'Meeting Sit / Talk',
    priority: 80,
    triggerKinds: Object.freeze(['runtime-flag', 'world-action', 'asset-id', 'action-location-role']),
    triggers: Object.freeze({ runtimeFlags: Object.freeze(['agent._idleActivity.kind=meeting-table-*', 'agent._idleActivity.kind=small-round-meeting-table-*', 'agent._idleActivity.kind=conference-chair-*']), roles: Object.freeze(['seat', 'meeting', 'talk', 'planning']), assets: Object.freeze(['meetingTable', 'smallRoundMeetingTable', 'conferenceChair']), actionPatterns: Object.freeze(['planning.meeting', 'smallRoundMeetingTablePlan', 'smallRoundMeetingTableTalk', 'meeting table', 'meeting sit', 'meeting talk']) }),
    pose: Object.freeze({ stance: 'seated', locomotion: 'stationary', blendMode: 'replace', bodyLean: 0.14, armMode: 'meeting-talk-gesture' }),
    runtimeAdapters: Object.freeze({ currentBranches: Object.freeze(['agent-characters.js meeting table / small round meeting table / conference chair branch']), currentFlags: Object.freeze(['agent._idleActivity.kind=meeting-table-*', 'agent._idleActivity.kind=small-round-meeting-table-*', 'agent._idleActivity.kind=conference-chair-*']) }),
  }),
  Object.freeze({
    id: 'tv-watch',
    label: 'Watch TV',
    priority: 72,
    triggerKinds: Object.freeze(['runtime-flag', 'world-action', 'asset-id']),
    triggers: Object.freeze({ runtimeFlags: Object.freeze(['agent._idleActivity.kind=tv-watch-*']), assets: Object.freeze(['tv']), actionPatterns: Object.freeze(['watchTv', 'watch tv']) }),
    pose: Object.freeze({ stance: 'standing', locomotion: 'stationary', blendMode: 'upper-body-overlay', bodyLean: 0.05, armMode: 'remote-watch-relax' }),
    runtimeAdapters: Object.freeze({ currentBranches: Object.freeze(['agent-characters.js core TV watch branch']), currentFlags: Object.freeze(['agent._idleActivity.kind=tv-watch-*']) }),
  }),
  Object.freeze({
    id: 'outdoor-planter-water',
    label: 'Water Outdoor Planter',
    priority: 73,
    triggerKinds: Object.freeze(['runtime-flag', 'world-action', 'asset-id']),
    triggers: Object.freeze({ runtimeFlags: Object.freeze(['agent._idleActivity.kind=outdoor-planter-water']), assets: Object.freeze(['outdoorPlanter']), actionPatterns: Object.freeze(['waterOutdoorPlanter', 'water planter']) }),
    pose: Object.freeze({ stance: 'standing', locomotion: 'stationary', blendMode: 'replace', bodyLean: 0.24, armMode: 'two-hand-pour-water' }),
    runtimeAdapters: Object.freeze({ currentBranches: Object.freeze(['agent-characters.js outdoor planter watering branch']), currentFlags: Object.freeze(['agent._idleActivity.kind=outdoor-planter-water']) }),
  }),
  Object.freeze({
    id: 'drink-eat',
    label: 'Drink / Eat',
  ...
  Object.freeze({
    id: 'dumbbell-workout',
    label: 'Paired Dumbbell Workout',
    priority: 86,
    triggerKinds: Object.freeze(['runtime-flag', 'world-action', 'asset-id', 'capability-tag']),
    triggers: Object.freeze({ runtimeFlags: Object.freeze(['agent._idleActivity.kind=dumbbell-rack-*']), assets: Object.freeze(['dumbbellRack']), actionPatterns: Object.freeze(['dumbbellCurls', 'dumbbellShoulderPress', 'dumbbellShoulderFlys', 'arm curls', 'shoulder press', 'shoulder flys', 'dumbbell', 'weights', 'fitness']), capabilityTags: Object.freeze(['training.practice']) }),
    pose: Object.freeze({ stance: 'standing', locomotion: 'stationary', blendMode: 'replace', bodyLean: 0.10, armMode: 'paired-dumbbell-curl-press-fly' }),
    runtimeAdapters: Object.freeze({ currentBranches: Object.freeze(['agent-characters.js paired dumbbell curls/shoulder-press/shoulder-flys branch with left/right hand props']), currentFlags: Object.freeze(['agent._idleActivity.kind=dumbbell-rack-*', 'agent._idleActivity.workoutMode']) }),
  }),
  Object.freeze({

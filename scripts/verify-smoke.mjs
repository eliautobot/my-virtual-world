...
for (const token of [
  ...
  'completedReactionTurnCount',
  'reactionTurnsByTriggerKind',
  'reactionMaxToolCallsPerTurn',
...
for (const token of [
  ...
  'js/main3d.js?v=20260621-presence-continuity-r1',
...
for (const token of [
  ...
  '"rest-at-home"',
  '"decorate-home-fridge"',
  '"life.restAtHome"',
  '"world.placeObject"',
  '"planning.brainstorm"',
  '"maintenance.printCopy"',
  '"world.buildStructure"',
  '"agent-home-placement"',
  '"agent-home-building"',
  '"main3d.js#routeLiveModeHomeWorldAction"',
  '"main3d.js#routeLiveModeHomeDecorateWorldAction"',
  '"home-rest"',
  '"home-decorate-place-object"',
  ...
  'def _execute_live_agent_todo_tool',
  'def _execute_live_agent_idle_tool',
...
for (const token of [
  ...
  'routeLiveModeHomeDecorateWorldAction',
  'home-decorate-place-object',
  'home-decorate-complete',
  'home-object-placed',
  'world.placeObject',
  'rested-at-home-bed',
